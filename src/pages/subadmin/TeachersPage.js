...
const handlePromoClick = (teacher) => {
  ...
  const handleBanSuccess = () => {
    fetchTeachers(); // ✅ now works since fetchTeachers is reusable
  };
            ...
            <>
              ...
              >
                <div style={{ fontWeight: 700, fontSize: 20, color: '#222' }}>
                  {showBanned ? 'Banned Teachers' : 'Active Teachers'} (
                    ...
                    >
                      ...
                      <td style={{ padding: '12px 8px' }}>
                        <div style={{ display: 'flex', gap: 8 }}>
                          ...
                          <button
  onClick={() => handlePromoClick(teacher)}
  style={{
    background: "none",
    border: "none",
    color: "#ffb020",
...
>
  <FaEdit />
      ...
      {promoModalOpen && selectedTeacher && (
  <PromoCodeModal
